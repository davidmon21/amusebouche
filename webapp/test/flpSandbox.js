		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Zapfi",
									"targetURL": "#zapfiproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zapfiproject2-display": {
								"semanticObject": "zapfiproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zapfi.project2",
									"url": sap.ui.require.toUrl("zapfi/project2")
								}
							}
						}
					}
